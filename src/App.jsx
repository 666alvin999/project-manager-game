          ...
          <div className="grid grid-cols-12 gap-4">
            <AnimatePresence>
              {sortedTickets.map((ticket) => (
                <motion.div key={ticket.id} layout initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.8 }} transition={{ duration: 0.5 }} className="col-span-12 md:col-span-6">
